...
default_args = {
  ...
  'mqtt_broker' : '2b6b72831fe34d86893bb56d020d2267.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_tssprojecttest1version1-4c74", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_tssprojecttest1version1-4c74"], schedule=None,catchup=False)
